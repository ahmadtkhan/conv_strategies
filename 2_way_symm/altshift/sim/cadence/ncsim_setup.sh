...
mkdir -p ./libraries/altshift_altshift_taps_201/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/../altshift_taps_201/sim/altshift_altshift_taps_201_as43lbi.v" -work altshift_altshift_taps_201 -cdslib ./cds_libs/altshift_altshift_taps_201.cds.lib
  ncvlog -compcnfg $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/altshift.v"                                                                                                                                          
fi
