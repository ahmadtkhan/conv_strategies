...
TOP_LEVEL_NAME="dsp"
QSYS_SIMDIR="./../"
QUARTUS_INSTALL_DIR="/cad1/Altera/20.1/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
mkdir -p ./libraries/dsp_altera_a10_native_fixed_point_dsp_201/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/../altera_a10_native_fixed_point_dsp_201/sim/dsp_altera_a10_native_fixed_point_dsp_201_ffpppjq.v" -work dsp_altera_a10_native_fixed_point_dsp_201 -cdslib ./cds_libs/dsp_altera_a10_native_fixed_point_dsp_201.cds.lib
  ncvlog -compcnfg $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dsp.v"                                                                                                                                                                                                                
fi
