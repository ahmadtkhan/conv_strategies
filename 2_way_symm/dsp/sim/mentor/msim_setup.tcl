...
# ----------------------------------------
# ACDS 20.1 711 linux 2026.01.24.13:01:55
...
if ![info exists QUARTUS_INSTALL_DIR] { 
  set QUARTUS_INSTALL_DIR "/cad1/Altera/20.1/quartus/"
}
...
ensure_lib                                           ./libraries/dsp_altera_a10_native_fixed_point_dsp_201/
vmap       dsp_altera_a10_native_fixed_point_dsp_201 ./libraries/dsp_altera_a10_native_fixed_point_dsp_201/
...
alias com {
  echo "\[exec\] com"
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../altera_a10_native_fixed_point_dsp_201/sim/dsp_altera_a10_native_fixed_point_dsp_201_ffpppjq.v" -work dsp_altera_a10_native_fixed_point_dsp_201
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dsp.v"                                                                                                                                           
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L dsp_altera_a10_native_fixed_point_dsp_201 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L twentynm_ver -L twentynm_hssi_ver -L twentynm_hip_ver $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -voptargs=+acc -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L dsp_altera_a10_native_fixed_point_dsp_201 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L twentynm_ver -L twentynm_hssi_ver -L twentynm_hip_ver $TOP_LEVEL_NAME
}
